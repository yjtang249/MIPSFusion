...
class iPhoneDataset(BaseDataset):
    ...
    def load_poses(self, basedir, starting_frame=0):
        '''
...
class TUMDataset(BaseDataset):
    def __init__(self, cfg, basedir, align=True, trainskip=1, 
        ...
        self.color_paths, self.depth_paths, self.poses = self.loadtum(basedir, frame_rate=32)
